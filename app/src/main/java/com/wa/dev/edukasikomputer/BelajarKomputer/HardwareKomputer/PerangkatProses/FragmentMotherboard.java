...
import com.wa.dev.edukasikomputer.BelajarKomputer.HardwareKomputer.PerangkatMasukan.Yutubquerty;
import com.wa.dev.edukasikomputer.R;

public class FragmentMotherboard extends Fragment {
    ImageView btn, yt;
    Context context;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context = getContext();
        btn = view.findViewById(R.id.bt_back_mmother);
        ...
        yt = view.findViewById(R.id.vid_motherboard);
        yt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(context, YTMotherboard.class);
                startActivity(a);
            }
        });
