...
public class FragmentPSU extends Fragment {
    ImageView btn, yt;
    Context context;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context = getContext();
        btn = view.findViewById(R.id.bt_back_psu);
        ...
        yt = view.findViewById(R.id.vid_psu);
        yt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(context, YTPSU.class);
                startActivity(a);
            }
        });
